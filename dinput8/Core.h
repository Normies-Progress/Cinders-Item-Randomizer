...
public:
	...
	virtual BOOL IsCovenantItem(DWORD dItemID);
	virtual BOOL IsShield(DWORD dItemID);
	virtual BOOL IsCatalyst(DWORD dItemID);
	virtual BOOL IsWeapon(DWORD dItemID);
...
struct SCore {
	...
	DWORD dRandomiseCovenantItems;
	DWORD dIsRandomInfusion;
	DWORD dIsRandomReinforcement;
	DWORD dIsRandomAffixation;
	DWORD dMinGoodsValue;
	DWORD dMaxGoodsValue;
